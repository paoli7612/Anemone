...
<div class="w3-panel w3-theme w3-card-4 w3-round-large w3-padding">
    <input type="date" class="w3-input w3-round-large" value="<?= App::today() ?>">
</div>
            ...
            <?php foreach (Merce::dailyCount() as $merce) : ?>
                <div class="w3-center w3-display-container">
                    ...
                    <div class="w3-display-right" style="width: 60%">
                        <input type="number" name="<?= $merce->id ?>_quantita" class="w3-input w3-card w3-round-large w3-left" style="width: 50%" placeholder="x1" onkeyup="update()">
