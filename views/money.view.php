        ...
        <div class="w3-theme w3-round-large" style="padding-top: 4px; padding-bottom: 4px">
            <?php for ($i = 0; $i < 4; $i++) : ?>
                <?php foreach (array(1, 2, 5) as $value) : ?>
                    <?php $value *= pow(10, $i) ?>
                    <div class="w3-row" style="margin: 4px 5px">
                        <div class="w3-col w3-center" style="width: 70px; margin-right:6px">
                            <img src="/img/money/<?= $value / 100 ?>.png" height="40px">
                        </div>
                        <div class="w3-right w3-small">
                            <button style="margin: 0px 2px" type="button" class="w3-button w3-card w3-circle w3-theme-l2 w3-right" onclick="var i=$(this).parent().parent().find('input').first(); i.val(+i.val()+10); i.keyup()">
                                +10
                            </button>
                            <button style="margin: 0px 2px" type="button" class="w3-button w3-card w3-circle w3-theme-l2 w3-right" onclick="var i=$(this).parent().parent().find('input').first(); i.val(+i.val()+1); i.keyup()">
                        ...
                        <input type="number" id="c<?= $value ?>" class="w3-hide" readonly>
                    </div>
                <?php endforeach ?>
            <?php endfor ?>
            <?php foreach ([1, 2, 3, 4, 5, 6] as $i) : ?>
                <div class="w3-row" style="margin: 4px 5px">
                    ...
                    <div class="w3-rest" style="margin-right: 2px">
